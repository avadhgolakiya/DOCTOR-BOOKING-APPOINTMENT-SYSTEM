                  ...
                  <tr>
                    <td style="background: linear-gradient(135deg, #5f6fff 0%, #7c8fff 50%, #9ca8ff 100%); padding: 0; position: relative; height: 200px;" class="header">
                      <table width="100%" cellpadding="0" cellspacing="0" style="height: 200px;">
                        <tr>
                          <td align="center" valign="middle">
                            <div style="width: 100px; height: 100px; background: rgba(255, 255, 255, 0.25); backdrop-filter: blur(10px); border-radius: 50%; display: inline-flex; align-items: center; justify-content: center; border: 3px solid rgba(255, 255, 255, 0.4); box-shadow: 0 10px 30px rgba(0,0,0,0.2);" class="success-icon">
