...
const FetchOtp = () => {
  ...
  const otpFormik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        const response = await axios.post(`${backendUrl}/doctor/verify-otp`, {
          email: emailSession,
          otp: otpString,
        });
  ...
  const resetFormik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        const response = await axios.put(`${backendUrl}/doctor/reset/password`, {
          email: emailSession,
  ...
  const handleResend = async () => {
    ...
    try {
      const response = await axios.post(`${backendUrl}/doctor/forget/password`, {
        email: emailSession,
      });
      if (response.data.success) {
